<template>
  ...
  <blank-bar pbgcolor="bg-secondary" ptext="pages"></blank-bar>
  <tab-bar
    :ptab="tab"
          ...
          <detail-main
            ...
            :pelements="[
              ...
              },
              {
                ...
                required: true,
                showcondition:
                  'lrecord.value[`type`] && (lrecord.value[`type`] == `link` || lrecord.value[`type`].value == `link`)',
                placeholder: true,
                placeholdervalue: 'pageurl.value = `https://travelmap.pages.dev/`;',
              },
              {
                label: 'html',
                name: 'html',
                ...
                required: true,
                showcondition:
                  'lrecord.value[`type`] && (lrecord.value[`type`] == `html` || lrecord.value[`type`].value == `html`)',
                placeholder: true,
                placeholdervalue:
                  '<html><head></head><body><h1>this is html in iframe</h1></body></html>',
              },
              {
                label: 'url html (url)',
                name: 'url',
