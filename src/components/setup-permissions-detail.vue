<template>
  ...
  <blank-bar pbgcolor="bg-secondary" ptext="permissions"></blank-bar>
  <tab-bar
    :ptab="tab"
    ...
    <q-scroll-area style="height: calc(100dvh - 137.01px); contain: style">
      <div class="q-pt-md q-pb-md q-ml-md q-mr-md">
        <detail-main
          ...
          pbacklink="setup-profiles-detail"
          :psilentelements="[
            {
              name: 'profile_id',
              value: profileid,
    ...
    function backButton() {
      if (window.history.state.back != null) {
        ...
        router.replace({
          ...
          params: { pid: route.params.pprofileid },
        });
      }
    }
