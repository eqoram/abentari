        ...
        <div v-for="element in tabOptions" :key="element.name">
          <div v-if="tab == element.name">
            <list-item
              ...
              pidentifier="name"
              pname="name"
              pdetaillink="setup-profiles-detail"
              :ploaddata="true"
              pobject="profiles"
              porderby="name"
              :pshowaddbutton="true"
              paddbuttonurl="setup-profiles-detail"
...
export default {
  ...
  setup() {
    ...
    const userid = ref('');
    const useremail = ref('');
    const tab = ref('all profiles');
    const tabOptions = ref([
      { name: 'all profiles', listfilter: false },
      {
